...
Router.post('/RankineCycle', (req, res) => {
    ...
    console.log(cycleType, cycleProperties, fluid, input1, value1, input2, value2, input3, value3)
    ...
    if (cycleProperties == 'RSI_1') {
      childPython.stdout.on('data', (data) => {
        ...
        propListFinal = [h1, h2, h3, h4, x4, vazaoMassica, qe, qs, wLiq, rendimento]
        if (propListFinal.length == 10 ) {
